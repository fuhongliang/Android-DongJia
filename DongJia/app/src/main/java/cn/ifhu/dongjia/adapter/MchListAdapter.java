...
public class MchListAdapter extends BaseLoadMoreAdapter<MchListDataBean.ListBean, MchListAdapter.ViewHolder> {


    private List<MchListDataBean.ListBean> mDatas;
    private Context context;
    private OnClickItem onClickItem;

    public MchListAdapter(List<MchListDataBean.ListBean> mDatas, Context context, OnClickItem onClickItem) {
        this.mDatas = mDatas;
    ...
    @Override
    public void setData(List<MchListDataBean.ListBean> data) {
        this.mDatas = data;
        resetLodingMore();
    ...
    public RecyclerView.ViewHolder getViewHolder() {
        return new ViewHolder(View.inflate(context, R.layout.item_home_super, null));
    }

    @Override
    public List<MchListDataBean.ListBean> getDataList() {
        return mDatas;
    }
