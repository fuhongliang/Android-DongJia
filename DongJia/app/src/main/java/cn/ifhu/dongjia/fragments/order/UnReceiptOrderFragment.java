 ...
 * 待收货页面
 */
public class UnReceiptOrderFragment extends BaseFragment {
    Unbinder unbinder;
    ...
    public static UnReceiptOrderFragment newInstance() {
        return new UnReceiptOrderFragment();
    }
    ...
    public void getOrderList() {
        ...
        RetrofitAPIManager.create(OrderServer.class).orderList(4, -1, -1, UserLogic.getUser().getAccess_token(), 2)
