...
public class GoodDetailsDataBean {
    ...
    private MchBean mch;
    private int show_integral;
    private List<String> coupon_title;
    ...
    public void setUse_attr(int use_attr) {
    ...
    public int getShow_integral() {
        return show_integral;
    }

    public void setShow_integral(int show_integral) {
        this.show_integral = show_integral;
    }

    public List<String> getCoupon_title() {
        return coupon_title;
    }

    public void setCoupon_title(List<String> coupon_title) {
    ...
    public void setAttr_group_list(List<AttrGroupListBean> attr_group_list) {
    ...
    public static class MchBean {
        ...
        private int id;
        private String name;
        private String mch_desc;
        private String header_color;
        private String mch_color;
        private String logo;
        ...
        public String getMch_desc() {
            return mch_desc;
        }

        public void setMch_desc(String mch_desc) {
            this.mch_desc = mch_desc;
        }
        ...
        public String getMch_color() {
            return mch_color;
        }

        public void setMch_color(String mch_color) {
            this.mch_color = mch_color;
        }
    ...
    public static class CouponListBean {
         ...
         * user_type : 1
         * is_receive : 0
         * begintime : 2019.07.03
         * endtime : 2019.07.03
         * show_time : 2019.07.03-2019.07.03有效
         * content : 全场商品通用
         * goods : []
         * cat : []
         */
        ...
        public void setCat_id_list(String cat_id_list) {
