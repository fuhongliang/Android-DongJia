...
import cn.ifhu.dongjia.BuildConfig;
...
public class RetrofitAPIManager {
    ...
    //正式环境
    private static String RELEASE_URL = "https://jiaju.ifhu.cn/";

    public static String DEV_URL = "https://testjiaju.ifhu.cn/";

    private static String TEST_URL = "https://testjiaju.ifhu.cn";
