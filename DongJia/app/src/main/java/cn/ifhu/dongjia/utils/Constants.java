...
public class Constants {
    ...
    public static final String MEICHANTINFO = "MerchantInfo";
    public static final String DEPOSTLISTBEAN = "DepostListBean";
    ...
    public static final String ORDERCOMING = "ORDERCOMING";


    public static final String APPLYCLASSLIST = "APPLYCLASSLIST";
